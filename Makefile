...
CFLAGS=-c -g -Os -w -Wall -ffunction-sections -fdata-sections 
#-mmcu=$(MCU) -DF_CPU=16000000L -DARDUINO=155 -DARDUINO_AVR_MEGA2560 -DARDUINO_ARCH_AVR -I$(ARDUINO_HOME)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_HOME)/hardware/arduino/avr/variants/mega -I./../libraries/SdFat
...
# 	$(CC) $(CFLAGS) -o $@ $^
# SdFatUtil.o SdFatErrorPrint.o SdBaseFile.o Sd2Card.o SdFat.o MinimumSerial.o istream.o SdFile.o SdSpiArduino.o SdSpiAVR.o SdSpiMK20DX128.o SdSpiSAM3X.o SdStream.o SdVolume.o
